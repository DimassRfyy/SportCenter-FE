          ...
          <Link to="/" className="menu">
            <div className="group flex flex-col items-center text-center gap-[10px]">
              <div className="w-6 h-6 flex shrink-0">
                <svg className="transition-all duration-300 group-hover:fill-[#F97316] fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="font-semibold text-sm leading-[21px] transition-all duration-300 group-hover:text-[#F97316] text-current">Discover</p>
            </div>
          </Link>
        </li>
        ...
        <li className="text-{{ Route::currentRouteName() == 'booking.check' ? '[#F97316]' : '[#13181D]' }}">
          <Link to='/check-booking' className="menu">
            <div className="group flex flex-col items-center text-center gap-[10px]">
              ...
              <p className="font-semibold text-sm leading-[21px] transition-all duration-300 group-hover:text-[#F97316] text-current">Bookings</p>
            </div>
          </Link>
        </li>

        <li className=" text-[#13181D]">
          <a href="#" className="menu">
            <div className="group flex flex-col items-center text-center gap-[10px]">
              ...
              <p className="font-semibold text-sm leading-[21px] transition-all duration-300 group-hover:text-[#F97316] text-current">Rewards</p>
            </div>
          </a>
        </li>
        ...
        <li className=" text-[#13181D]">
          <a href="#" className="menu">
            <div className="group flex flex-col items-center text-center gap-[10px]">
              ...
              <p className="font-semibold text-sm leading-[21px] transition-all duration-300 group-hover:text-[#F97316] text-current">Support</p>
            </div>
          </a>
        </li>
      </ul>
