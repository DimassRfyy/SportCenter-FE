  ...
  return (
    ...
    <ul className="flex justify-evenly max-[400px]:justify-between">
        <li className="text-{{ Route::currentRouteName() == 'front.index' ? '[#F97316]' : '[#13181D]' }}">
            <a href="{{ route('front.index') }}" className="menu">
                <div className="group flex flex-col items-center text-center gap-[10px]">
                    <div className="w-6 h-6 flex shrink-0">
                        <svg className="transition-all duration-300 group-hover:fill-[#F97316]  fill-current" width="24"
                    ...
                    <p
                        className="font-semibold text-sm leading-[21px] transition-all duration-300 group-hover:text-[#F97316] text-current">
                        Discover</p>
                </div>
            </a>
        </li>
        ...
        <li className="text-{{ Route::currentRouteName() == 'booking.check' ? '[#F97316]' : '[#13181D]' }}">
            <a href="{{ route('booking.check') }}" className="menu">
                <div className="group flex flex-col items-center text-center gap-[10px]">
                    <div className="w-6 h-6 flex shrink-0">
                        <svg className="transition-all duration-300 group-hover:fill-[#F97316]  fill-current" width="25"
